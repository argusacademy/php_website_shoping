...
<style>
.m{background-color:red;color:white;font-family:cooper black;font-size:40px;margin:5px;}
.a{background-color:cyan;height:500px;margin:10px;}
...
<div class="fluid-container">
	<div class="row">
		<div class="col-md-12">
			<div class="m">
			<marquee > WELOCME to FRESH FOOD </marquee>
			</div>
		</div>
	</div>
