...
<style>
.m{background-color:gray;color:white;font-family:cooper black;margin:5px;padding:10px;}
...
if($sq)
{
		...
		{
				$sq=mysqli_query($cn,$q);
		echo '<table border="5px" bordercolor="white" >
		...
		<tr>';
				...
				$cid=$r['cid'];
						...
						echo '<th>  '.$r['phone'].'</th>
						<th><a href="adel_reg.php?x='.$cid.'"> delete</a></th>
						</tr>';
				}
				echo'</table>';
		}
